...
internal class NativeAlternativePaymentActivityContract : ActivityResultContract
<PONativeAlternativePaymentConfiguration, ProcessOutActivityResult<POUnit>>() {
    ...
    override fun createIntent(
        context: Context,
        input: PONativeAlternativePaymentConfiguration
    ) = Intent(context, NativeAlternativePaymentActivity::class.java)
