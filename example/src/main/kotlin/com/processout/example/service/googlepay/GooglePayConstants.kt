 ...
 * Please take a look at [GooglePayConfiguration] to see where the constants are used and to potentially
 ...
 * is not applicable to your app, remove the relevant bits from [GooglePayConfiguration].
 ...
 *  5.  If you're using `DIRECT` integration, please edit protocol version and public key as per the instructions.
 */
object GooglePayConstants {
    /**
     * Changing this to ENVIRONMENT_PRODUCTION will make the API return chargeable card information.
     * Please refer to the documentation to read about the required steps needed to enable ENVIRONMENT_PRODUCTION.
     *
     ...
     * The number of parameters required and their names vary depending on the processor.
     *
     ...
     * Can be removed when using `PAYMENT_GATEWAY` tokenization.
     *
